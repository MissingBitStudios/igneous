...
breathe_projects = {
   'igneous': abspath('../build/doxygen/xml/')
}
...
breathe_default_project = 'igneous'
...
latex_documents = [
    (master_doc, 'Igneous.tex', 'Igneous Documentation',
...
man_pages = [
    (master_doc, 'igneous', 'Igneous Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Igneous', 'Igneous Documentation',
     author, 'Igneous', 'Igneous is an open source game engine written in C++.',
     'Miscellaneous'),
]
