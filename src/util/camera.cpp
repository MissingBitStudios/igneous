...
void Camera::update(float dt)
{
	...
	if (Input::keys[GLFW_KEY_UP]) view = glm::rotate(glm::radians(-5.0f) * speed * dt, glm::vec3(1.0f, 0.0f, 0.0f)) * view;
	if (Input::keys[GLFW_KEY_DOWN]) view = glm::rotate(glm::radians(5.0f) * speed *  dt, glm::vec3(1.0f, 0.0f, 0.0f)) * view;
	if (Input::keys[GLFW_KEY_LEFT]) view = glm::rotate(glm::radians(-5.0f) * speed *  dt, glm::vec3(0.0f, 1.0f, 0.0f)) * view;
	if (Input::keys[GLFW_KEY_RIGHT]) view = glm::rotate(glm::radians(5.0f) * speed *  dt, glm::vec3(0.0f, 1.0f, 0.0f)) * view;
